...
CSS = """
:root{--navy:#13006a;--navy-2:#1f1188;--line:#cfd6e6;--soft:#f5f6fb;--text:#1c1f37;--muted:#5f6782;--white:#fff;--green:#eaf9f0;--greenline:#bde2cb}
...
.top-nav{max-width:1680px;margin:14px auto 0;display:flex;justify-content:center;gap:14px;flex-wrap:wrap}
.nav-pill{font-family:Georgia,'Times New Roman',serif;border:1px solid var(--navy);background:#fff;color:var(--navy);border-radius:999px;padding:9px 24px;font-size:24px;font-weight:700}
